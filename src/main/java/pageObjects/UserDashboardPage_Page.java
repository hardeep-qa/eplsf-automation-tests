...
public class UserDashboardPage_Page extends BasePage {
	...
	// ...................USER DASHBOARD PAGE LOCATORS....................//
		...
		public @FindBy(xpath = "//span[text()='form2']") WebElement List_Available_Form_User_Dashboard_page;
		...
		public @FindBy(xpath = "//div[@class='ajs-message ajs-error ajs-visible']") WebElement Error_Message_On_Login_page;
		public @FindBy(id = "new_form_desktop") WebElement Button_NewForm_UserDashboard;
		public @FindBy(xpath = "//ul[@class='new_form_ddoptions']//em[contains(text(),'Blank Form')]") WebElement Link_BlankForm_UserDashboard;
		public @FindBy(xpath = "//div[@class='columns small-12']//input[@type='text']") WebElement Textbox_FormName_PopUp_On_UserDashboard;
		public @FindBy(id = "create-blank-form-button") WebElement Button_CreateForm_PopUP_UserDashboard;
