...
public class HomePage_Page extends BasePage {
	...
	private @FindBy(xpath = "//li[@id='lemon_logo']/a[text() = 'Easy Peasy Lemon Squeezy Forms']") WebElement link_logo_header;
	private @FindBy(xpath = "//li[@id='menu-item-43']/a[text() = 'Features']") WebElement link_features_header;
	private @FindBy(xpath = "//li[@id='menu-item-42']/a[text() = 'Pricing']") WebElement link_pricing_header;
	private @FindBy(xpath = "//li[@id='menu-item-41']/a[text() = 'Support']") WebElement link_support_header;
	private @FindBy(xpath = "//a[contains(text(), 'Login') and @class= 'top_login buttons']") WebElement button_login_header;
	private @FindBy(xpath = "//a[contains(text(), 'Register') and @class='top_register buttons']") WebElement button_register_header;
	private @FindBy(xpath = "//a[@href='/blog']") WebElement link_blog_header;
	private @FindBy(xpath = "//span[contains(text(), 'Call Us')]") WebElement text_callUs_header;
	private @FindBy(xpath = "//*[contains(text(), '0800 111 106')]") WebElement text_0800111106_header;

	// ...................APPLICATION FOOTER LOCATORS....................//
	private @FindBy(xpath = "//ul[@id='menu-foot_links-1']/li[1]/a[text() = 'Home']") WebElement link_Home_footer;
	private @FindBy(xpath = "//ul[@id='menu-foot_links-1']/li[2]/a[text() = 'Features']") WebElement link_features_footer;
	private @FindBy(xpath = "//ul[@id='menu-foot_links-1']/li[3]/a[text() = 'Pricing']") WebElement link_pricing_footer;
	private @FindBy(xpath = "//ul[@id='menu-foot_links-1']/li[4]/a[text() = 'Support']") WebElement link_support_footer;
	private @FindBy(xpath = "//ul[@id='menu-foot_links-1']/li[5]/a[text() = 'Blog']") WebElement link_blog_footer;
	private @FindBy(xpath = "//div[@class = 'user_nav large-6 columns']/ul/li/a[text() = 'Login']") WebElement link_login_footer;
	private @FindBy(xpath = "//div[@class = 'user_nav large-6 columns']/ul/li/a[text() = 'Register']") WebElement link_register_footer;
	private @FindBy(xpath = "//a[@href='/about']") WebElement link_about_footer;
	private @FindBy(xpath = "//a[@href='/terms']") WebElement link_terms_of_use_footer;
	private @FindBy(xpath = "//a[@href='/privacy']") WebElement link_privacy_footer;
	private @FindBy(xpath = "//p[contains(text(),'Copyright © 2018 Easy Peasy Lemon Squeezy Forms.')]") WebElement link_copyright_trademark_footer;

	// ...................APPLICATION HOMEPAGE BODY
	// LOCATORS....................//
	private @FindBy(xpath = "//div[@id='teaser_content']/div/div/a") WebElement button_signup_body_first;
	private @FindBy(xpath = "//div[@id='second_content']/a") WebElement button_signup_body_second;
	private @FindBy(xpath = "//div[@id='paperless']/div/div/a") WebElement button_signup_body_third;
	private @FindBy(xpath = "//div[@id='bottom_signup']/div/div[2]/a") WebElement button_signup_body_fourth;
